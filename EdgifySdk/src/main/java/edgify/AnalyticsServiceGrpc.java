...
public final class AnalyticsServiceGrpc {
  ...
  public static final String SERVICE_NAME = "edgify.AnalyticsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<edgify.Analytics.CreateAnalyticsEventRequest,
      edgify.Analytics.CreateAnalyticsEventResponse> getCreateEventMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateEvent",
      requestType = edgify.Analytics.CreateAnalyticsEventRequest.class,
      responseType = edgify.Analytics.CreateAnalyticsEventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edgify.Analytics.CreateAnalyticsEventRequest,
      edgify.Analytics.CreateAnalyticsEventResponse> getCreateEventMethod() {
    io.grpc.MethodDescriptor<edgify.Analytics.CreateAnalyticsEventRequest, edgify.Analytics.CreateAnalyticsEventResponse> getCreateEventMethod;
    if ((getCreateEventMethod = AnalyticsServiceGrpc.getCreateEventMethod) == null) {
      synchronized (AnalyticsServiceGrpc.class) {
        if ((getCreateEventMethod = AnalyticsServiceGrpc.getCreateEventMethod) == null) {
          AnalyticsServiceGrpc.getCreateEventMethod = getCreateEventMethod =
              io.grpc.MethodDescriptor.<edgify.Analytics.CreateAnalyticsEventRequest, edgify.Analytics.CreateAnalyticsEventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateEvent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edgify.Analytics.CreateAnalyticsEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edgify.Analytics.CreateAnalyticsEventResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AnalyticsServiceMethodDescriptorSupplier("CreateEvent"))
              .build();
        }
      }
    }
  ...
  public static abstract class AnalyticsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createEvent(edgify.Analytics.CreateAnalyticsEventRequest request,
        io.grpc.stub.StreamObserver<edgify.Analytics.CreateAnalyticsEventResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                edgify.Analytics.CreateAnalyticsEventRequest,
                edgify.Analytics.CreateAnalyticsEventResponse>(
  ...
  public static final class AnalyticsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AnalyticsServiceBlockingStub> {
    ...
    /**
     */
    public edgify.Analytics.CreateAnalyticsEventResponse createEvent(edgify.Analytics.CreateAnalyticsEventRequest request) {
  ...
  public static final class AnalyticsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AnalyticsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edgify.Analytics.CreateAnalyticsEventResponse> createEvent(
        edgify.Analytics.CreateAnalyticsEventRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_EVENT:
          serviceImpl.createEvent((edgify.Analytics.CreateAnalyticsEventRequest) request,
              (io.grpc.stub.StreamObserver<edgify.Analytics.CreateAnalyticsEventResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AnalyticsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edgify.Analytics.getDescriptor();
    }
